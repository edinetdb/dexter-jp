---
# TODO(dexter-jp): JP localization pending. This skill was ported as-is from
# upstream and is US-market oriented (US tickers, SEC framing, English output).
# Translate prompts/examples to Japanese and adapt to EDINET DB / J-Quants tools
# (Japanese securities reports, 大量保有報告書, etc.) before promoting for JP users.
name: write-memo
